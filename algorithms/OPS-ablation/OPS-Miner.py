"""Standalone L2-incremental Newsup using support-first PPC fusion."""
...
class L2IncrementalPPCNewsup:
    """Reuse length-2 IDs and apply PPC before every higher-level fusion."""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Standalone L2-incremental PPC-Newsup"
    )
    ...
    algorithm = L2IncrementalPPCNewsup(
        args.window,
        args.step,
        args.minsup,
    )
